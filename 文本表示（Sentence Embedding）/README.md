...
* **Self-Guided Contrastive Learning for BERT Sentence Representations**  *Taeuk Kim, Kang Min Yoo, Sang-goo Lee*  (ACL 2021)  [[ACL pdf]](https://aclanthology.org/2021.acl-long.197.pdf)  [[notes]]()
* **PromptBERT: Improving BERT Sentence Embeddings with Prompts**  *Ting Jiang, Shaohan Huang, Zihan Zhang, Deqing Wang, Fuzhen Zhuang, Furu Wei, Haizhen Huang, Liangjie Zhang, Qi Zhang*  [[pdf]](https://arxiv.org/pdf/2201.04337v1.pdf)  [[code]](https://github.com/kongds/prompt-bert)  -***PromptBERT***
