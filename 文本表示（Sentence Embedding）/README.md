...
* **DiffCSE: Difference-based Contrastive Learning for Sentence Embeddings**  *Yung-Sung Chuang, Rumen Dangovski, Hongyin Luo, Yang Zhang, Shiyu Chang, Marin Soljačić, Shang-Wen Li, Wen-tau Yih, Yoon Kim, James Glass*  (NAACL 2022)  [[pdf]](https://arxiv.org/pdf/2204.10298.pdf)
* **Generative or Contrastive? Phrase Reconstruction for Better Sentence Representation Learning**  *Bohong Wu, Hai Zhao*  [[pdf]](https://arxiv.org/pdf/2204.09358.pdf)
