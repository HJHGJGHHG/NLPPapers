...
def args_initialization():
    ...
    parser.add_argument('--learning_rate', default=5e-4, type=float, help='try 5e-5, 2e-5 for BERT, 1e-3 for others')
    ...
    parser.add_argument('--seed', default=123, type=int, help='set seed for reproducibility')
